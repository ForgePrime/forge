...
| [ADR-025](ADR-025-actor-and-business-process-entities.md) | Actor + BusinessProcess entities with Finding.actor_refs/process_refs JSONB + BusinessAnalysisCompleteness validator; legacy-row exemption; LLM-based extraction with Steward review. Closes FC §9 + AI-SDLC §7 Business Analysis + AI-SDLC #8 business_justification (Tier 2 extension). Stage B.8 in PLAN_MEMORY_CONTEXT | decision CLOSED · content DRAFT | 2026-04-24 | user |
| [ADR-026](ADR-026-architecture-components-unified-view.md) | Architecture components unified view: architecture_components (7-kind enum) + architecture_component_relationships tables + changes.architecture_components_affected + 3 validators (arch_change, ssot_uniqueness, rollback_ref) + dashboard. Closes AI-SDLC §9 + #9. Stage E.9 in PLAN_CONTRACT_DISCIPLINE | decision CLOSED · content DRAFT | 2026-04-24 | user |
