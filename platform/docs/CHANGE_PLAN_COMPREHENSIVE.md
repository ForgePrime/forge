...
- `ITRP/.ai/CONTRACT.md` — [READ, cited as prompt-specified source]
- `ITRP/.ai/theorems/Context-Complete Evidence-Guided Agent Process.md` — [READ throughout prior sessions; cited as CCEGAP C1–C12]
- `ITRP/.ai/theorems/Engineer_Soundness_Completeness.md` — [READ; cited as ESC §1–§8]
- `ITRP/.ai/theorems/Epistemic_Continuity_and_Information_Topology_Preservation_for_AI_Agent_Systems.md` — [READ; cited as ECITP §2–§7]
- `ITRP/.ai/theorems/Error_Discovery.md` — [READ in this session, invoked via deep-verify pattern]
...
- `ITRP/.ai/framework/PRACTICE_SURVEY.md` — [NOT READ in this session; prompt allows adding if needed; findings relying on it tagged [ASSUMED: PRACTICE_SURVEY content not verified]]
